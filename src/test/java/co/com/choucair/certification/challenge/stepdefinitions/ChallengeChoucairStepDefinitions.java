...
public class ChallengeChoucairStepDefinitions {
    ...
    public void thatLuisVallejoIsOnTheUTestHomePage() {
        OnStage.theActorCalled("luisVallejo").wasAbleTo(OpenUp.thePage());
    }
    ...
    public void heEntersAllRequiredRegistrationFields(List<ChallengeChoucairData> challengeChoucairData) throws Exception {
        OnStage.theActorCalled("luisVallejo").attemptsTo(Register.onThePage(
